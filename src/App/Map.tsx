...
const Content = (props: Props) => {
  ...
  const addMarkers = (mapObject: any, data: any) => {
    ...
    mapObject.on("render", () => {
      ...
      //     mapObject.loadImage(
      //       "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRngdTKUc8b24IT3uIhN5BZV5uSBXjU5N5SfA&usqp=CAU",
      //       function (error: any, res: string) {
      //         mapObject.addImage("cat", res);
      //       }
      //     );
      ...
      //       type: "geojson",
      //       data: geojson,
      //       coordinates: [[data[index]["緯度"], data[index]["経度"]]],
      //     });
